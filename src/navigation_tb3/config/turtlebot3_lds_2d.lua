...
options = {
  ...
  submap_publish_period_sec = 0.1,  -- Increased period for submap release (seconds)
  ...
  odometry_sampling_ratio = 1.0,  -- Reduced odometry sampling ratio
...
TRAJECTORY_BUILDER_2D.submaps.num_range_data = 35  -- 35Number of range data for submaps in the 2D track builder  
